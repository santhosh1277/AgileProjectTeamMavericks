...
import { GetStudentDetails, UpdateStudentDetails } from "../api/Service.js/StudentService";

jest.mock("../api/Service.js/StudentService");
...
describe("Profile Component", () => {
  ...
  test("clicking save calls UpdateStudentDetails and resets edit fields", async () => {
    GetStudentDetails.mockResolvedValueOnce(mockStudentData);
    UpdateStudentDetails.mockResolvedValueOnce({ ...mockStudentData, firstName: "Sam" });
